...
class ResultCodeResolver
{
     ...
     *
     * 공통 일시오류(5003/5004/5005/9000/3011/3013)에 더해, 알림톡 일시오류
     * (7306 카카오 시스템오류·7307 처리지연·7421 타임아웃·7437 메시지 요청실패)도 포함한다.
    ...
    /**
     * 잔액 부족 코드 — 문자 9070 / 알림톡 7436 (D3 자체 알림 대상).
     */
    private const BALANCE_LOW_CODES = ['9070', '7436'];
